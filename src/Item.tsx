...
const Item = ({ dragableAreaSize, item, positions, index, containerHeight = height - 80, contentHeight, scrollY, scrolViewRef, itemHeight, onFinish, renderItem }: ItemProps) => {
          ...
          dragableAreaSize && dragableAreaSize > 0 ?
            <React.Fragment>
              ...
              <PanGestureHandler onGestureEvent={onGestureEvent}>
                <Animated.View style={[StyleSheet.absoluteFill, { right: 'auto', width: dragableAreaSize }]} />
              </PanGestureHandler>
            </React.Fragment>
            :
            <PanGestureHandler onGestureEvent={onGestureEvent}>
